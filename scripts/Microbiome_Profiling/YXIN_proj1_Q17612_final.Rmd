...
colnames(phyloseq::sample_data(psdata_Genus_lowN))
...
phyloseq::sample_data(psdata_Genus_lowN_rel_v2)$replicate = factor(phyloseq::sample_data(psdata_Genus_lowN_rel_v2)$replicate)
phyloseq::sample_data(psdata_Genus_lowN_rel_v2)$sludge_source = factor(phyloseq::sample_data(psdata_Genus_lowN_rel_v2)$sludge_source, levels = c("Bath", "Almere"))
